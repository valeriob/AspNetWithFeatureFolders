...
namespace AspNetWithFeatures.Features.Calculator
{
    public partial class CalculatorController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CalculatorController Actions { get { return MVC.Calculator; } }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CalculatorController : AspNetWithFeatures.Features.Calculator.CalculatorController
    {
        public T4MVC_CalculatorController() : base(Dummy.Instance) { }
